...
export const mapLocations: MapLocation[] = [
  ...
  { id: 'wasserauen', name: 'Wasserauen', position: [47.2827, 9.4103], aliases: ['wasserauen'] },
  { id: 'gossau-sg', name: 'Gossau SG', position: [47.4153, 9.2509], aliases: ['gossau sg', 'gossau'] },
  { id: 'lugano-nord', name: 'Lugano Stazione Nord', position: [46.0099, 8.9506], aliases: ['lugano stazione nord', 'stazione nord'] },
  { id: 'st-moritz-bahnhof', name: 'St. Moritz Bahnhof', position: [46.4979, 9.8454], aliases: ['st. moritz bahnhof', 'st moritz bahnhof'] },
